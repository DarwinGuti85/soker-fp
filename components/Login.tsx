...
const Login: React.FC = () => {
    ...
    return (
        <div 
            className="min-h-screen font-sans relative overflow-hidden bg-gray-50 dark:bg-brand-bg-dark"
        >
            {theme === 'dark' && (
            ...
            <div className="absolute inset-0 flex items-center justify-center p-4">
                <div className="relative z-10 w-full max-w-sm bg-white/80 dark:bg-brand-bg-light/80 backdrop-blur-lg border border-gray-200 dark:border-white/10 rounded-xl shadow-2xl p-8 space-y-6">
                    
                    {/* Header */}
                    <div className="text-center space-y-4">
                        <h1 className="login-neon-title">𝕊𝕆𝕂𝔼ℝ 𝔽ℙ</h1>
                        <div>
                            <h2 className="text-2xl font-bold text-gray-900 dark:text-white tracking-wider">Bienvenido</h2>
                            <p className="text-gray-600 dark:text-gray-300 text-sm">Ingresa tus credenciales para acceder.</p>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div>
                            <input
                                ...
                                className="w-full px-4 py-2.5 bg-gray-100 dark:bg-brand-bg-dark/70 border border-gray-300 dark:border-gray-700 rounded-md text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-brand-orange/50 focus:border-brand-orange focus:outline-none transition-colors duration-300"
                                required
                                autoCapitalize="none"
                            />
                        </div>
                        ...
                        <div className="flex items-center justify-between text-xs pt-1">
                            <div className="flex items-center gap-2">
                                <input type="checkbox" id="remember" className="h-4 w-4 bg-transparent border-gray-400 dark:border-gray-500 text-brand-orange rounded focus:ring-brand-orange focus:ring-offset-0"/>
                                <label htmlFor="remember" className="text-gray-600 dark:text-gray-300">Recordarme</label>
                            </div>
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full bg-brand-orange text-white font-bold py-2.5 rounded-md transition-colors duration-300 hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white dark:ring-offset-black/50 focus:ring-brand-orange disabled:bg-orange-900/70 disabled:cursor-not-allowed !mt-6"
                        >
